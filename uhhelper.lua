...
if file then
    ...
    sampAddChatMessage("{00FFCC}[Ultimate Helper] {FF0000}FILE NOT FOUND: Definations.json", -1)
end
...
local locations = {
    ...
    {keywords={"Ober Taxi Services"}, X=1733.206542, Y=-1911.986450, Z=13.562113},
    {keywords={"TimeLess Interiors"}, X=934.672790, Y=-1443.019897, Z=13.546875},
    {keywords={"Genovese LLC", "LLC"}, X=952.596252, Y=-909.106628, Z=45.765625},
    {keywords={"Genovese Aution house[LSC]", "Auction House", "LSC"}, X=948.552917, Y=-916.349548, Z=45.175640},
...
function register_commands()
	...
	sampRegisterChatCommand("uhupdates", function()
		...
		sampAddChatMessage("{FFFFFF}v1.2.1 {BBBBBB}- Auto chat splitting for /n or /newb", -1)
		sampAddChatMessage("{FFFFFF}v1.2.1 {BBBBBB}- Added all the Current companies HQ(6/12/2025)", -1)
    ...
    sampRegisterChatCommand('newb', cmdN)
